...
#define ATTACH_POINT 		"ControlRoom"  			// This must be the same name that is used for the client.
...
#define I2_ATTACH_POINT	 	"TrainHost"				// Hostname Full path for Node2
#define I2_ATTACH_DEVICE	"VM_x86_Target03"		// Target Device for ndoe 2
