...
#define CLIENT_ID 			545						// ID of the client
#define ATTACH_POINT 		"TrainController1"  		// This must be the same name that is used for the client.
#define NUMBER_CLIENT		1						// Number of servers the client is talking to
#define I1_ATTACH_POINT  	"TrainHost"  			// Hostname Full path for Node1
...
#define I2_ATTACH_DEVICE	"VM_x86_Target02"		// Target Device for node 2
