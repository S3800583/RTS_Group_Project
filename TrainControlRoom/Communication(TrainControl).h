...
#define CLIENT_ID 			565						// ID of the client
#define ATTACH_POINT 		"TrainHost"  			// This must be the same name that is used for the client.
#define NUMBER_CLIENT		2						// Number of servers the client is talking to
#define I1_ATTACH_POINT  	"ControlRoom"  			// Hostname Full path for Node1
#define I1_ATTACH_DEVICE	"VM_x86_Target02"		// Target Device for node 1
#define I2_ATTACH_POINT	 	"TrainController1"				// Hostname Full path for Node2
#define I2_ATTACH_DEVICE	"VM_x86_Target04"		// Target Device for ndoe 2
